defmodule MyBank.AccountsTest do
  use MyBank.DataCase
  ...
  describe "accounts" do
    ...
    @create_user_attrs %{email: "some email", name: "some name", password_hash: "some password_hash"}

    @valid_attrs %{balance: 120.5, description: "some description", value: 120.5}
    @update_attrs %{balance: 456.7, description: "some updated description", value: 456.7}
    @invalid_attrs %{balance: nil, description: nil, value: nil}
